...
subtitle: "Financial incentives might be the key to helping smokers kick the habit. Let's dive into a groundbreaking study that put this idea to the test with real people at a large company—not in a lab."
format:
  revealjs:
    slide-number: false
    preview-links: auto
...
## Smoking: Still America's Leading Preventable Killer
