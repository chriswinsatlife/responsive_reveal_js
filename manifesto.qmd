...
subtitle: "What History Teaches Us About Unlocking the Power of Leverage"
format:
  revealjs:
    slide-number: false
    preview-links: auto
...
::: {.notes}
Okay. So today, we're going to explore a game-changing concept that has shaped history and will define our future: delegation. This isn't just about offloading tasks; it's about unlocking human potential on a scale we've never seen before.<break time="1.0s" />
:::
